<%@ Page Title="" Language="C#" MasterPageFile="~/AdminView/AdminNavigate.Master" AutoEventWireup="true" CodeBehind="AdminAddType.aspx.cs" Inherits="CoffeeShopManagement.AdminView.AdminAddType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-style-5">
        <legend><span class="number">1</span>Create Category</legend>
        ...
        <asp:Button ID="btnAction" runat="server" Text="Add New Type" OnClick="btnAction_Click" />
    </div>
</asp:Content>
